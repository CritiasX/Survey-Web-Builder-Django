...
urlpatterns = [
    ...
    path('student/surveys/history/', views.student_history, name='student_history'),
    path('student/surveys/responses/<int:response_id>/', views.student_view_response, name='student_view_response'),
